...
function RightControl() {
  return (
    <div className="w-30 h-81 bg-red-800 border-3 rounded-r-3xl flex flex-col items-center justify-between p-4">
      {/* Joystick */}
      ...
      {/* 4 Botones en forma de rombo - Negros */}
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          {/* Derecha (A) */}
          <button className="w-8 h-8 bg-black rounded-full hover:bg-gray-800 font-bold text-white text-sm">A</button>
        </div>
